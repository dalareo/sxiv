 ...
 */
static const char * const BAR_FONT = "-*-tamsyn-medium-r-*-*-13-*-*-*-*-70-*-*";
...
static const char * const SEL_COLOR    = "#db0a5b";
static const char * const BAR_BG_COLOR = "#db0a5b";
static const char * const BAR_FG_COLOR = "#f5f5f5";
